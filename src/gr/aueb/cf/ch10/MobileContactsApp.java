...
//            System.out.printf("%s\t%s\t%s\n", contact[0], contact[1], contact[2]);
    ...
    public static void printContactMenu() {
        System.out.println("Εισάγετε Όνομα, Επώνυμα και Τηλέφωνο");
    }
...
//            e.printStackTrace();
    ...
    public static boolean update(String oldPhoneNumber, String firstname, String lastname, String newPhoneNumber) {         //παραλλαγή γίνεται με String[]
        int positionToUpdate = getIndexByPhoneNumber(oldPhoneNumber);
        String[] contact = new String[3];

        if (positionToUpdate == - 1) {
            return false; //return new String[] {};
        }
...
//        return contact;
    ...
    /*
     * Custom logger.
     * Varargs (οι τρεις τελίτσες...) String[] message
     * log(Exception)
     */
