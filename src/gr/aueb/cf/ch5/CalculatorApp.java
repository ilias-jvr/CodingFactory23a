...
/**
 * Υλοποιεί έναν απλό calculator που παρέχει τις υπηρεσίες
 * add, sub, mul, dic, mod.
 * Εμφανίζει ένα μενού προς τον χρήστη με επιλογές,
 * λαμβάνει την τιμή της επιλογής και στη συνέχεια δύο ακόμα τιμές των num1, num2.
...
//        return value;
//    }
//    τρόπος γραφής κώδικα ώστε να έχω ένα return.
